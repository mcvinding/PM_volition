...
plt.ylabel('Density', fontsize=12)
plt.xlabel('Difference', fontsize=12)
plt.title('Bias ($\it{Fixed}$ - $\it{Free}$)',fontsize=14)
plt.tight_layout()
...
plt.ylabel('Density', fontsize=12)
plt.xlabel('Difference', fontsize=12)
plt.title('Non-decision time ($\it{Fixed}$ - $\it{Free}$)',fontsize=14)
plt.tight_layout()
...
plt.ylabel('Density', fontsize=12)
plt.xlabel('Difference', fontsize=12)
plt.title('Drift rate ($\it{Filler}$ - $\it{PM}$)',fontsize=14)
plt.tight_layout()
...
plt.ylabel('Density', fontsize=12)
plt.xlabel('Difference', fontsize=12)
plt.title('Decision threshold ($\it{Filler}$ - $\it{PM}$)',fontsize=14)
plt.tight_layout()
...
plt.ylabel('Density', fontsize=12)
plt.xlabel('Difference', fontsize=12)
plt.title('Bias ($\it{Filler}$ - $\it{PM}$)',fontsize=14)
plt.tight_layout()
